...
public class ComputerMain {
    ...
    public static void main(String[] args) {
        ...
        ComputerLaptop cl2 = new ComputerLaptop("Ubuntu", 14.0, 2.0, 4);
        ComputerLaptop cl3 = new ComputerLaptop("macOS", 13.3, 2.0, 8);
        ComputerLaptop cl4 = new ComputerLaptop("ChromeOS", 13.3, 2.0, 16);
